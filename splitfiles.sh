#!/bin/bash
# Short script to split videos by filesize using ffmpeg by LukeLR (take from stack overflow: https://stackoverflow.com/questions/38259544/using-ffmpeg-to-split-video-files-by-size)
