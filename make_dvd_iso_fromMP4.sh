...
get_maxdvdbitrate "$1"
dvdffmpegcommand="ffmpeg -y -i \"$1\" -r:v ntsc -c:v mpeg2video -c:a ac3 -f dvd -mbd rd -s 720x480 -pix_fmt yuv420p -g 18 -bf 2 -b:v $MAXDVDBITRATE -maxrate $MAXDVDBITRATE -bt 400k -top 0 -flags +ildct+ilme -minrate 0 -bufsize 3600k -packetsize 2048 -muxrate 10080000 -lmin 1 -lmax 200000 -b:a 448000 -ar 48000 \"${1%.*}.mpeg\""
